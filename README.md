...
| ---------------------------- | -------------------------- | ------------------------------------ |
| ![Server](https://github.com/pranjals07/DiagnosAR/blob/assets/server.png) | ![Unity]([assets/unity.png](https://github.com/pranjals07/DiagnosAR/blob/assets/unity.png)) | ![Prediction]([assets/prediction.png](https://github.com/pranjals07/DiagnosAR/blob/assets/prediction.png)) |
